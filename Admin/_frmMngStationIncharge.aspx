<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="_frmMngStationIncharge.aspx.cs" Inherits="BikeSharingSystem.Admin._frmMngStationIncharge" %>
        ...
        <tr>
            <td colspan="3">
                <h2 style="text-align: center;">
                    <strong>MANAGE STATION INCHARGER</strong></h2>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                    ErrorMessage="*" ForeColor="#FF3300" ValidationGroup="a" 
       ...
       <%-- <tr>
        ...
        <tr>
            <td>
                <b>&nbsp; Station Name</b></td>
            <td>
                <asp:DropDownList ID="ddlstnName" runat="server">
                </asp:DropDownList>
            </td>
            <td>
                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                    ControlToValidate="ddlstnName" ErrorMessage="Select Name." ForeColor="#FF3300" 
                    Operator="NotEqual" ValidationGroup="a" ValueToCompare="Select"></asp:CompareValidator>
            </td>
        </tr>
        <tr>
            ...
            &nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" ForeColor="#CC9900" 
        ...
        <tr>
            <td colspan="3">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="Msi_Id" HeaderText="StnInc_Id" />
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="LB_Edit" runat="server" CommandArgument='<%# Eval("Msi_Id") %>'
                                onclick="LB_Edit_Click">Edit</asp:LinkButton>
                                <asp:LinkButton ID="LB_Delete" runat="server" CommandArgument='<%# Eval("Msi_Id") %>'
